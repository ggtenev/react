...
for(let i = 1; i <= 100; i++){
    let numToPrint = i;
    if(i%3 === 0 && i%5 !==0) numToPrint = "Fizz";
    else if (i%5 === 0 && i%3 !== 0) numToPrint = "Buzz";
    else if(i%5 === 0 && i%3 === 0) numToPrint = "FizzBuzz";
...
let gridTiles = prompt('?');
let line = "";
for(let i = 1; i <= gridTiles; i++){
    for(let j = 1; j <= gridTiles; j++){
        if(i%2 !== 0){
            if(j%2 !== 0) line += " ";
            else line += "#";
        }else {
